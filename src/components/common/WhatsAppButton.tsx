...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      {/* Tooltip on Desktop */}
      <div
        className={`hidden sm:flex items-center gap-2 bg-[#090C15] text-white px-3.5 py-2 rounded-xl text-xs font-semibold shadow-xl border border-slate-800 transition-all duration-300 pointer-events-none ${
          isHovered
